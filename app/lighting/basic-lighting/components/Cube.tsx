...
import { Color, Mesh, Object3D, PerspectiveCamera, ShaderMaterial, Vector3 } from "three";
...
const Cube = forwardRef<PerspectiveCamera>(({ }, ref) => {
    ...
    useFrame((state) => {
        ...
        material.current.uniforms.uLightPosition.value = light.current.object.position;
    });
    return (
        <>
            ...
            <TransformControls position={[5, 5, 5]} ref={light} mode="translate">
                <Box>
