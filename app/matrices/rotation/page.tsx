  ...
  return (
    <>
      ...
      <div className='fixed pl-80 w-screen left-0 top-10 z-10'>
        <Container p='4'>
          <Heading size='4' weight='light'>
            A Rotation Matrix is a 4x4 matrix used in 3D graphics to represent the orientation of an object in space.<br />
            It is commonly composed of a series of 4x4 matrices, with each matrix representing a rotation around a specific axis.<br />
          </Heading>
          <Box mt={'2'}>
          ...
          <Section size='1' mt={'2'} className='flex justify-center items-center'>
            <Box className='text-blue-400'>
              ...
              <p className='text-center'><KatexEquation text={'\\text{x-axis}'} /></p>
            </Box>
            <Box className='text-red-400'>
              <KatexEquation text={getRotationYMatrix(radians[1])} />
              <p className='text-center'><KatexEquation text={'\\text{y-axis}'} /></p>
            </Box>
            <Box className='text-green-400'>
              <KatexEquation text={getRotationZMatrix(radians[2])} />
              <p className='text-center'><KatexEquation text={'\\text{z-axis}'} /></p>
            </Box>
            <Box className=''>
              <KatexEquation text={`= ${finalRotation}`}></KatexEquation>
              <p className='text-center'><KatexEquation className='ml-5' text={'\\text{ final rotation}'} /></p>
            </Box>
          </Section>
        </Container>
      </div>
      <div className='fixed pl-80 w-screen left-0 bottom-10 z-10'>
        <Section p='6'>
          <Blockquote>Explore the impact of different rotation values on each axis, observing how they dynamically influence the object's orientation in 3D space.</Blockquote>
        </Section>
      </div>
    </>
  )
